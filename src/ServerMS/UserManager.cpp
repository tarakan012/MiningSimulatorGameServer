...
namespace ServerMS {
    ...
    void CUserManager::OnUsersUpdate() {
        TIME_MILSEC n64TimeNow = Time::GetTimeMillis();
    ...
    DB::CDBConnector *CUserManager::GetDBSource(INT32 actorID) {
    ...
    void CUserManager::DBAsyn_ExeSQL(CBuffer *pBuffer, DB::CDBConnector *pConnector) {
